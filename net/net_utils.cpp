...
template<>
channel_state_t get_channel_state(const pt::io::link_state_t &other_state)
{
    switch(other_state)
    {
        case pt::io::link_state_t::ready:
            return channel_state_t::ready;
        break;
        case pt::io::link_state_t::opening:
            return channel_state_t::opening;
        break;
        case pt::io::link_state_t::open:
            return channel_state_t::open;
        break;
        case pt::io::link_state_t::connecting:
            return channel_state_t::connecting;
        break;
        case pt::io::link_state_t::connected:
            return channel_state_t::connected;
        break;
        case pt::io::link_state_t::disconnecting:
            return channel_state_t::disconnecting;
        break;
        case pt::io::link_state_t::disconnected:
            return channel_state_t::disconnected;
        break;
        case pt::io::link_state_t::closing:
            return channel_state_t::closing;
        break;
        case pt::io::link_state_t::closed:
            return channel_state_t::closed;
        break;
        case pt::io::link_state_t::failed:
