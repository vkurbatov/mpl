...
struct ssl_session_factory::pimpl_t
{
    ...
    {
        ssl_session_factory::pimpl_t&   m_owner;
...
ssl_session_factory::ssl_session_factory(const ssl_manager_config_t &config)
    : m_pimpl(pimpl_t::create(config))
{

}

ssl_session_factory::~ssl_session_factory()
{

}

const i_ssl_certificate *ssl_session_factory::certificate() const
{
    return m_pimpl->certificate();
}

i_ssl_session::u_ptr_t ssl_session_factory::create_session(const ssl_session_params_t &params
                                                           , i_ssl_session::i_listener *listener)
{
...
bool ssl_session_factory::is_valid() const
{
